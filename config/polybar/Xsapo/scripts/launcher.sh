...
FILE="$HOME/.config/polybar/Xsapo/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/Xsapo/scripts/rofi/launcher.rasi
